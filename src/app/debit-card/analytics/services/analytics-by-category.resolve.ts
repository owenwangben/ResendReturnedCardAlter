...
@Injectable()
export class AnalyticsByCategoryResolve implements Resolve<BillAnalyticsByCategoryItem[]> {
	constructor(private service: AnalyticsService, private pipe: DatePipe) { }
	async resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Promise<BillAnalyticsByCategoryItem[]> {
